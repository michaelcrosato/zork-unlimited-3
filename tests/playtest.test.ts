...
function trueEndingCount(endings: Record<string, number>): number {
  return (
    ...
    (endings.mara_thumbprint_receipt_true_ending ?? 0) +
    ...
    (endings.passenger_manifest_handoff_door_checked_true_ending ?? 0) +
    (endings.passenger_manifest_thumbprint_true_ending ?? 0) +
    (endings.mara_manifest_thumbprint_receipt_true_ending ?? 0) +
    ...
    (endings.passenger_conductor_clearance_checked_true_ending ?? 0) +
    ...
    (endings.passenger_keepsake_owner_checked_true_ending ?? 0) +
