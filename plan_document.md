...
```json
{
  ...
  "narrative_gaps": ["Found Mara's badge but don't know who Mara is yet."],
  "suggestions": ["Add 'examine desk' option in service_room to hint at key location."]
}
```
...
Where should the _blind_ LLM playtester live?
